...
use widgets::{fields, Attribute};
use widgets::{Align, Axis, BorderStyle, Display, Sides, TextAlignment, Wrap};
use widgets::{Easing, Fragment, Number, Path, Value};

use super::error::{Error, Result};
use super::lexer::{Lexer, Meta, Token, TokenKind};
use crate::ctx::SubContext;
...
mod test {
    ...
    fn parse_a_widget() {
        ...
        let (ident, output) = parser.next().unwrap().unwrap();
