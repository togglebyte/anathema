use anathema_render::{Buffer, ScreenPos, Size, Style};
...
/// ```
/// use anathema_widgets::{Canvas, LocalPos};
...
mod test {
    ...
    // use crate::{Border, BorderStyle, LocalPos, Sides};
    ...
    //     }
    //     border.add_child(canvas.into_container(NodeId::anon()));
