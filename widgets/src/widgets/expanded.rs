...
///
/// ```
/// # use widgets::{NodeId, HStack, Constraints, Widget};
/// use widgets::Expand;
...
mod test {
    ...
    fn style_changes_via_attributes() {
        ...
        assert!(expand.to::<Expand>().style.attributes.contains(display::Attributes::ITALIC));
    }
}
