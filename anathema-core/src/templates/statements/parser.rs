use crate::templates::components::{AssocEventMapping, ComponentTemplates, TemplateSource};
use crate::templates::error::{src_line_no, Error, ParseError, ParseErrorKind, Result};
use crate::templates::expressions::parser::parse_expr;
use crate::templates::expressions::Expression;
use crate::templates::statements::Statement;
use crate::templates::strings::{StringId, Strings};
use crate::templates::token::{Kind, Operator, Tokens, Value};
...
pub(crate) struct Parser<'src, 'strings, 'components> {
    tokens: Tokens,
    components: &'components ComponentTemplates,
...
mod test {
    ...
    fn parse(src: TemplateSource) -> Vec<Result<Statement>> {
        ...
        components.insert(x_id, TemplateSource::InMemory(String::new()));
