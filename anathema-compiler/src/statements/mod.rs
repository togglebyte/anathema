...
use super::components::{AssocEventMapping, ComponentTemplates, TemplateSource};
...
pub(crate) struct Context<'vars> {
    ...
    pub(crate) components: &'vars ComponentTemplates,
...
impl<'vars> Context<'vars> {
    pub fn new(
        ...
        components: &'vars ComponentTemplates,
